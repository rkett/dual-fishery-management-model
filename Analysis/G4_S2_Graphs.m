...
(*Plot[CS2,{x,((ehats-a)/b),k}/.trueVanilla]*)
(**)
(*(*EV2*)*)
...
(**)
(*Plot3D[-(1/(2 k ns pids[x]^2))(-2 betas CS2 gammas k pics[x] pids[x]+(2 betas CS2 gammas k+k ns (-gammas+CS2 eco qo^2+b CS2 qs+crit r)-2 (crit+k) ns r x+3 ns r x^2+k ns (CS2 qs^2 ecs[x]+no qo edo[x]+(-CS2+ns) qs eds[x])) pids[x]^2+\[Sqrt](pids[x]^2 ((-2 betas CS2 gammas k pics[x]+(2 betas CS2 gammas k+k ns (-gammas+CS2 eco qo^2+b CS2 qs+crit r)-2 (crit+k) ns r x+3 ns r x^2+k ns (CS2 qs^2 ecs[x]+no qo edo[x]+(-CS2+ns) qs eds[x])) pids[x])^2+4 k ns (betas CS2 k ns qs x Dpids[x] (ecs[x]-eds[x]) pics[x]+pids[x] (betas CS2 k ns qs x Dpics[x] (-ecs[x]+eds[x])+gammas (k (CS2 eco qo^2+b CS2 qs+crit r)-2 (crit+k) r x+3 r x^2+k no qo edo[x]+k qs (CS2 qs ecs[x]+(-CS2+ns) eds[x])) (2 betas CS2 pics[x]+(-2 betas CS2+ns) pids[x]))))))/.trueVanilla,{x,((ehats-a)/b),k}/.trueVanilla,{eco,0,0.6},AxesLabel->{Subscript[SuperStar[x], 4],Subscript[(e^C), o][t],Subscript[\[Lambda], 1]},PlotLabel->"Graph of \!\(\*SubscriptBox[\(\[Lambda]\), \(1\)]\)(\!\(\*SubscriptBox[SuperscriptBox[\(x\), \(*\)], \(4\)]\)(t),\!\(\*SubscriptBox[SuperscriptBox[\(C\), \(*\)], SubscriptBox[\(s\), \(2\)]]\)(t),0) versus Real \!\(\*SubscriptBox[SuperscriptBox[\(x\), \(*\)], \(4\)]\)(t) and OMNRF Cooperator Effort from 0 to 0.6"]*)
(**)
(*(*EV3*)*)
(*1/(2 k ns pids[x]^2) (2 betas CS2 gammas k pics[x] pids[x]-(2 betas CS2 gammas k+k ns (-gammas+CS2 eco qo^2+b CS2 qs+crit r)-2 (crit+k) ns r x+3 ns r x^2+k ns (CS2 qs^2 ecs[x]+no qo edo[x]+(-CS2+ns) qs eds[x])) pids[x]^2+\[Sqrt](pids[x]^2 ((-2 betas CS2 gammas k pics[x]+(2 betas CS2 gammas k+k ns (-gammas+CS2 eco qo^2+b CS2 qs+crit r)-2 (crit+k) ns r x+3 ns r x^2+k ns (CS2 qs^2 ecs[x]+no qo edo[x]+(-CS2+ns) qs eds[x])) pids[x])^2+4 k ns (betas CS2 k ns qs x Dpids[x] (ecs[x]-eds[x]) pics[x]+pids[x] (betas CS2 k ns qs x Dpics[x] (-ecs[x]+eds[x])+gammas (k (CS2 eco qo^2+b CS2 qs+crit r)-2 (crit+k) r x+3 r x^2+k no qo edo[x]+k qs (CS2 qs ecs[x]+(-CS2+ns) eds[x])) (2 betas CS2 pics[x]+(-2 betas CS2+ns) pids[x]))))))/.trueVanilla;*)
(*Plot3D[1/(2 k ns pids[x]^2) (2 betas CS2 gammas k pics[x] pids[x]-(2 betas CS2 gammas k+k ns (-gammas+CS2 eco qo^2+b CS2 qs+crit r)-2 (crit+k) ns r x+3 ns r x^2+k ns (CS2 qs^2 ecs[x]+no qo edo[x]+(-CS2+ns) qs eds[x])) pids[x]^2+\[Sqrt](pids[x]^2 ((-2 betas CS2 gammas k pics[x]+(2 betas CS2 gammas k+k ns (-gammas+CS2 eco qo^2+b CS2 qs+crit r)-2 (crit+k) ns r x+3 ns r x^2+k ns (CS2 qs^2 ecs[x]+no qo edo[x]+(-CS2+ns) qs eds[x])) pids[x])^2+4 k ns (betas CS2 k ns qs x Dpids[x] (ecs[x]-eds[x]) pics[x]+pids[x] (betas CS2 k ns qs x Dpics[x] (-ecs[x]+eds[x])+gammas (k (CS2 eco qo^2+b CS2 qs+crit r)-2 (crit+k) r x+3 r x^2+k no qo edo[x]+k qs (CS2 qs ecs[x]+(-CS2+ns) eds[x])) (2 betas CS2 pics[x]+(-2 betas CS2+ns) pids[x]))))))/.trueVanilla,{x,((ehats-a)/b),k}/.trueVanilla,{eco,0,0.6},AxesLabel->{Subscript[SuperStar[x], 4],Subscript[(e^C), o][t],Subscript[\[Lambda], 2]},PlotLabel->"Graph of \!\(\*SubscriptBox[\(\[Lambda]\), \(2\)]\)(\!\(\*SubscriptBox[SuperscriptBox[\(x\), \(*\)], \(4\)]\)(t),\!\(\*SubscriptBox[SuperscriptBox[\(C\), \(*\)], SubscriptBox[\(s\), \(2\)]]\)(t),0) versus Real \!\(\*SubscriptBox[SuperscriptBox[\(x\), \(*\)], \(4\)]\)(t) and OMNRF Cooperator Effort from 0 to 0.6"]*)
